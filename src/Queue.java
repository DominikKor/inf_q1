...
public class Queue<ContentType> {
	...
	/**
	 * Das erste Objekt wird aus der Schlange entfernt und zurueckgegeben. 
	 * Falls die Schlange leer ist, wird sie nicht veraendert und es wird null zurueckgegeben.
	 */
	public ContentType dequeue() {
		ContentType hilf = null;
		if (!this.isEmpty()) {
			hilf = head.getContent();
			head = head.getNext();
			if (this.isEmpty()) {
				head = null;
				tail = null;
